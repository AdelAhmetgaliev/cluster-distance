...
set output "color_indexes_corrected.png"

plot "../data/main_color_indexes_interp.dat" with line ls 5 lc rgb 'red' title "Линия нормальных цветов", \
    "../data/stars_color_indexes_corrected.dat" with points ls 5 lc rgb 'blue' ps 2 title "Звезды кластера скорректированные"
