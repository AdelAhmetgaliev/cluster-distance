...
plot "../data/main_color_indexes.dat" with points ls 5 lc rgb 'red' ps 2 title "Звезды ГП", \
    ...
    [-0.4:1.2245]f(x) with line ls 5 lc rgb 'green' title "Линия покраснения №1", \
    [-0.4:0.4007]g(x) with line ls 5 lc rgb 'purple' title "Линия покраснения №2", \
    [-0.4:0.3381]h(x) with line ls 5 lc rgb 'navy' title "Линия покраснения №3"
